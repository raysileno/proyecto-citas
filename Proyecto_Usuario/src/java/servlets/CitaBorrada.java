 ...
 * @author Eric
 */
@WebServlet(name = "CitaBorrada", urlPatterns = {"/CitaBorrada"})
public class CitaBorrada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>SU CITA HA SIDO ELIMINADA CORRECTAMENTE.</h1>");
