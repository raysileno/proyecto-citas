...
@NamedQueries({
    ...
    , @NamedQuery(name = "Citas.findByOrden", query = "SELECT c FROM Citas c WHERE c.orden = :orden")})
public class Citas implements Serializable {
    ...
    public Citas(String codigoCita, Usuario usu, String fecha, String hora, boolean llamado, Tramites tramite, int orden) {
        this.codigoCita = codigoCita;
        this.dniUsuario = usu;
        this.fecha = fecha;
        this.hora = hora;
