...
public class ModificarEmpleado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<head>");
            out.println("<title>Modificar empleado</title>");   
            out.println("<link rel='stylesheet' type='text/css' href='resource/index.css'/>");
            out.println("</head>");
            out.println("<body>");
            out.println("<div class='center'>");
            Empleado e = new Empleado(request.getParameter("dni"), request.getParameter("nombre"), request.getParameter("apellidos"), request.getParameter("pass"), Integer.parseInt(request.getParameter("tiptra")), Integer.parseInt(request.getParameter("tiptra")));
            conEJB.modificarEmpleado(e);
            out.println("<h1>EMPLEADO MODIFICADO CORRECTAMENTE</h1>");
